...
Goal:
- Test whether V11 can switch from 452 to 514 after the 2015 China stock-market / RMB shock starts spreading into global risk assets.
...
def make_summary(weekly: pd.DataFrame, switch_log: pd.DataFrame, start: str, end: str) -> str:
    ...
    lines.append("- Good: 2015-2016 China/RMB shock / risk expansion shifts to 514 early and avoids false bear-market rebounds.")
    ...
    lines.append("- R6 medium repair lane: 514 can release to 452 only after medium repair conditions hold for 2 weeks; this test checks whether 2015-2016 risk-off rebounds are filtered out.")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run V11-Core 2015-2016 China/RMB Shock Backtest R7.")
    ...
    weekly_csv = out_dir / "v11_core_2015_weekly_modes.csv"
    switch_csv = out_dir / "v11_core_2015_switch_log.csv"
    summary_md = out_dir / "v11_core_2015_summary.md"
